...
def exercise12(n):
    ...
    checkerboard_matrix[::2, ::2] = checkerboard_matrix[1::2, 1::2] = 1
...
def exercise13(n):
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    s = pd.Series(np.random.randint(0,n,n), index = pd.date_range('2010-01-01', periods = n)).cumsum().plot()
    plt.show()
